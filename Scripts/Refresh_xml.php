...
// Get all the measurements done in the past minute
$sql = "SELECT * FROM $dbname.Wind_Data, $dbname.Users WHERE (Wind_Data.device_id = Users.device_id AND Wind_Data.timestamp >= DATE_SUB(NOW(), INTERVAL 1 MINUTE))"; 
